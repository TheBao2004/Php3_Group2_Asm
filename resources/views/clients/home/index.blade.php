        ...
        <div class="slick-slider hero hero-header-01"
            ...
            <div class="vh-100 d-flex align-items-center">
                ...
                <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100 light-mode-img"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-01.jpg')}}"></div>
                <div class="lazy-bg bg-overlay dark-mode-img position-absolute z-index-1 w-100 h-100"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-white-01.jpg')}}"></div>
            </div>
            <div class="vh-100 d-flex align-items-center">
                <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                    <div class="hero-content text-start">
                ...
                <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100 light-mode-img"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-02.jpg')}}"></div>
                <div class="lazy-bg bg-overlay dark-mode-img position-absolute z-index-1 w-100 h-100"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-white-02.jpg')}}"></div>
            </div>
            <div class="vh-100 d-flex align-items-center">
                <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                    <div class="hero-content text-start">
                ...
                <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100 light-mode-img"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-03.jpg')}}"></div>
                <div class="lazy-bg bg-overlay dark-mode-img position-absolute z-index-1 w-100 h-100"
                    data-bg-src="{{asset('assets/clients/images/hero-slider/hero-slider-white-03.jpg')}}"></div>
            </div>
        </div>
    </section>
    <section>
                    ...
                    <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="shop/product-details-v1.html" class="hover-zoom-in d-block" title="Shield Conditioner">
                                <img src="#" data-src="{{asset('assets/clients/images/products/product-01-330x440.jpg')}}"
                    ...
                    <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                ...
                                <img src="#" data-src="{{asset('assets/clients/images/products/product-02-330x440.jpg')}}"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Perfecting
                                    Facial Oil</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                    ...
                    <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                ...
                                <img src="#" data-src="{{asset('assets/clients/images/products/product-03-330x440.jpg')}}"
                        ...
                        <div class="card-body text-center p-0">
                            ...
                            <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3">
                                <a class="text-decoration-none text-reset" href="shop/product-details-v1.html">Enriched
                                    Hand &amp; Body Wash</a>
                            </h4>
                            <div class="d-flex align-items-center fs-12px justify-content-center">
                                <div class="rating">
                    ...
                    <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="shop/product-details-v1.html" class="hover-zoom-in d-block" title="Shield Shampoo">
                                <img src="#" data-src="{{asset('assets/clients/images/products/product-04-330x440.jpg')}}"
                                    class="img-fluid lazy-image w-100" alt="Shield Shampoo" width="330"
                                    height="440" />
                            </a>
                            <div class="position-absolute product-flash z-index-2">
                                <span class="badge badge-product-flash on-sale bg-primary">-24%</span>
                            </div>
                            <div class="position-absolute d-flex z-index-2 product-actions horizontal">
                                <a class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm add_to_cart"
                                    href="#" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="card card-product grid-1 bg-transparent border-0" data-animate="fadeInUp">
                        <figure class="card-img-top position-relative mb-7 overflow-hidden">
                            <a href="shop/product-details-v1.html" class="hover-zoom-in d-block"
                                ...
                                <img src="#" data-src="{{asset('assets/clients/images/products/product-05-330x440.jpg')}}"
    ...
    <section class="container container-xxl">
        <div class="row gy-30px">
            <div class="col-lg-6" data-animate="fadeInUp">
                <div class="card border-0 rounded-0 banner-01 hover-zoom-in hover-shine">
                    <img class="lazy-image object-fit-cover card-img light-mode-img" src="#"
                        data-src="{{asset('assets/clients/images/banner/banner-01.jpg')}}" width="690" height="420"
                        alt="Intensive Glow C&#43; Serum" />
                    <img class="lazy-image dark-mode-img object-fit-cover card-img" src="#"
                        data-src="{{asset('assets/clients/images/banner/banner-white-01.jpg')}}" width="690" height="420"
                        alt="Intensive Glow C&#43; Serum" />
            ...
            <div class="col-lg-6" data-animate="fadeInUp">
                <div class="card border-0 rounded-0 banner-01 hover-zoom-in hover-shine">
                    <img class="lazy-image object-fit-cover card-img light-mode-img" src="#"
                        data-src="{{asset('assets/clients/images/banner/banner-02.jpg')}}" width="690" height="420"
                        alt="25% off Everything" />
                    <img class="lazy-image dark-mode-img object-fit-cover card-img" src="#"
                        data-src="{{asset('assets/clients/images/banner/banner-white-02.jpg')}}" width="690" height="420"
                        alt="25% off Everything" />
                    <div class="card-img-overlay d-inline-flex flex-column p-md-12 m-md-2 p-8">
                ...
                <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
                    <div class="icon-box icon-box-style-1 card border-0 text-center">
                        ...
                        <div class="icon-box-content card-body pt-4">
                            <h3 class="icon-box-title card-title fs-5 mb-4 pb-2">
                                Free Shipping
                            </h3>
                            <p class="icon-box-desc card-text fs-18px mb-0">
        ...
        <div class="container container-xxl">
            ...
            <div class="slick-slider mt-12"
                ...
                <div data-animate="fadeInUp">
                    <div class="bg-transparent text-center">
                        <img class="lazy-image w-auto mx-auto mb-6 light-mode-img" src="#"
                            data-src="./assets/images/testimonial/testimonial-03.png" width="150" height="82"
                        ...
                        <img class="lazy-image dark-mode-img w-auto mx-auto mb-6" src="#"
                            data-src="./assets/images/testimonial/testimonial-white-03.png" width="150" height="82"
                            alt="Also the customer service is phenomenal. I would purchase again." />
                        <p class="fs-5 fw-semibold mx-xl-9 px-xl-2 mb-0 text-body-emphasis">
                ...
                <div data-animate="fadeInUp">
                    <div class="bg-transparent text-center">
                        <img class="lazy-image w-auto mx-auto mb-6 light-mode-img" src="#"
                            data-src="./assets/images/testimonial/testimonial-02.png" width="150" height="82"
                            alt="Great product line. Very attentive staff to deal with." />
                        <img class="lazy-image dark-mode-img w-auto mx-auto mb-6" src="#"
                            data-src="./assets/images/testimonial/testimonial-white-02.png" width="150" height="82"
                            alt="Great product line. Very attentive staff to deal with." />
                        <p class="fs-5 fw-semibold mx-xl-9 px-xl-2 mb-0 text-body-emphasis">
                ...
                <div data-animate="fadeInUp">
                    <div class="bg-transparent text-center">
                        <img class="lazy-image w-auto mx-auto mb-6 light-mode-img" src="#"
                            data-src="./assets/images/testimonial/testimonial-01.png" width="150" height="82"
                            alt="Looking to affordably upgrade your everyday dinnerware? Look no further than e.Space" />
                        <img class="lazy-image dark-mode-img w-auto mx-auto mb-6" src="#"
                            data-src="./assets/images/testimonial/testimonial-white-01.png" width="150" height="82"
                            alt="Looking to affordably upgrade your everyday dinnerware? Look no further than e.Space" />
                        <p class="fs-5 fw-semibold mx-xl-9 px-xl-2 mb-0 text-body-emphasis">
                            “Looking to affordably upgrade your everyday dinnerware? Look
                            no further than e.Space“
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-5 mb-10 mb-lg-0" data-animate="fadeInUp">
                    <div class="card border-0 rounded-0 hover-zoom-in hover-shine">
                        <img class="lazy-image w-100 img-fluid card-img object-fit-cover banner-02 light-mode-img"
                            src="#" data-src="./assets/images/banner/banner-33.jpg" width="570" height="913"
    ...
    <section class="pt-14 pb-md-12 pb-8 pb-lg-17 pt-lg-21">
        <div class="container container-xxl">
            <div class="text-center" data-animate="fadeInUp">
                ...
                <p class="fs-18px w-lg-60 w-xl-40 mx-md-16 mx-lg-auto mb-13">
                    ...
                    <div class="card border-0">
                        <div class="image-box-4">
                            <img class="lazy-image img-fluid lazy-image light-mode-img" src="#"
                                data-src="./assets/images/image-box/image-box-10-1.jpg" width="960" height="640"
                                alt />
                            <img class="lazy-image dark-mode-img img-fluid lazy-image" src="#"
                                data-src="./assets/images/image-box/image-box-white-10-1.jpg" width="960"
                                height="640" alt />
                        </div>
                        <div class="card-body text-body-emphasis text-center pt-9 mt-2">
                            ...
                            <a href="#" title="Shop now"
                                class="btn btn-link fw-semibold text-body-emphasis">Shop now
                                <i class="far fa-arrow-right fs-14px ps-2 ms-1"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-8 mb-md-0" data-animate="fadeInUp">
                    <div class="card border-0">
                        <div class="image-box-4">
                            <img class="lazy-image img-fluid lazy-image light-mode-img" src="#"
                                data-src="./assets/images/image-box/image-box-12.jpg" width="960" height="640"
                                alt />
                            <img class="lazy-image dark-mode-img img-fluid lazy-image" src="#"
                        ...
                        <div class="card-body text-body-emphasis text-center pt-9 mt-2">
                            ...
                            <a href="#" title="Shop now"
                                class="btn btn-link fw-semibold text-body-emphasis">Read more
                                <i class="far fa-arrow-right fs-14px ps-2 ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="mx-n6 slick-slider"
                    ...
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-01.jpg" title="instagram-01"
                            ...
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-01-320x320.jpg" alt="instagram-01"
                                src="#" />
                    ...
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-02.jpg" title="instagram-02"
                            ...
                            class="hover-zoom-in hover-shine card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-02-320x320.jpg" alt="instagram-02"
                                src="#" />
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-03.jpg" title="instagram-03"
                            ...
                            class="hover-zoom-in hover-shine card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-03-320x320.jpg" alt="instagram-03"
                                src="#" />
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-04.jpg" title="instagram-04"
                            ...
                            class="hover-zoom-in hover-shine card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-04-320x320.jpg" alt="instagram-04"
                                src="#" />
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-05.jpg" title="instagram-05"
                            ...
                            class="hover-zoom-in hover-shine card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-05-320x320.jpg" alt="instagram-05"
                                src="#" />
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
                    <div class="px-6" data-animate="fadeInUp">
                        <a href="assets/images/instagram/instagram-06.jpg" title="instagram-06"
                            ...
                            class="hover-zoom-in hover-shine card-img-overlay-hover hover-zoom-in hover-shine d-block">
                            <img class="lazy-image img-fluid w-100" width="314" height="314"
                                data-src="./assets/images/instagram/instagram-06-320x320.jpg" alt="instagram-06"
                                src="#" />
                            <span class="card-img-overlay bg-dark bg-opacity-30"></span>
                        </a>
                    </div>
