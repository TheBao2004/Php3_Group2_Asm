                                ...
                                <div class="product-item">
                                    <figure class="product-thumb">
                                        <a href="product-details.html">
                                            <img class="pri-img" src="{{ Storage::url($product ->hinh_anh )}}"
                                                alt="product">
                                            <img class="sec-img" src="{{ Storage::url($product ->hinh_anh )}}"
                                                alt="product">
                                        </a>
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <h6 class="product-name">
                                            <a href="product-details.html">{{ $product -> ten_san_pham }}</a>
                                        </h6>
                                        <div class="price-box">
                                            <span class="price-regular">{{ $product -> gia_khuyen_mai }}</span>
                                            <span class="price-old"><del>{{ $product -> gia_san_pham }}</span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-12">
                <div class="deals-carousel-active--two slick-row-10 slick-arrow-style">
                    ...
                    <div class="hot-deals-item product-item">
                        <figure class="product-thumb">
                            <a href="product-details.html">
                                <img src="{{ Storage::url($product -> hinh_anh) }}" alt="product">
                            </a>
                            <div class="product-badge">
                                <div class="product-label new">
                                    <span>sale</span>
                        ...
                        <div class="product-caption">
                            ...
                            <div class="price-box">
                                ...
                                <span class="price-old"><del>{{ $product -> gia_san_pham }}</del></span>
                            </div>
